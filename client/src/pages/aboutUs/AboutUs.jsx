...
const AboutUs = () => {
  ...
  const features = [
    {
      ...
      description:
        "Streamlined application handling with real-time tracking and professional guidance throughout your journey.",
    },
    {
      icon: <FaGlobe className="w-12 h-12 text-primary" />,
      title: "Global Network",
      description:
        "Extensive partnerships with embassies and consulates worldwide, ensuring smooth processing across borders.",
    },
    {
      icon: <FaUserTie className="w-12 h-12 text-primary" />,
      title: "Dedicated Support",
      description:
        "Personal visa consultants available to guide you through requirements and documentation.",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-base-100">
      <Helmet>
        <title>
          About Visa Navigator - Your Trusted Visa Processing Partner
        </title>
        <meta
          name="description"
          content="Learn about Visa Navigator's professional visa processing services, global network, and commitment to excellence in international travel documentation."
        />
      </Helmet>
        ...
        <div className="container mx-auto px-4">
          <motion.div {...fadeInUp} className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl md:text-2xl text-base-content/80 mb-8">
              Your premiere destination for seamless visa processing and expert
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-base-content/80 leading-relaxed">
              To revolutionize the visa application process through innovative
              technology and exceptional service. We&apos;re committed to making
              international travel documentation accessible, efficient, and
              stress-free for individuals and businesses worldwide.
            </p>
          </div>
        </div>
      </motion.div>
